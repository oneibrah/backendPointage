...
public  class UtilisateursController {
    ...
    @GetMapping("login")
    public Utilisateur connexion (@RequestParam String login, @RequestParam String password, @RequestBody Pointage pointage){
        pointageService.ajoutPointage(pointage);
