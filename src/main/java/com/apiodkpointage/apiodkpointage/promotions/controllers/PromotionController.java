...
public class PromotionController {
    ...
    Promotion ajouter(@RequestBody Promotion promotion,@PathVariable Long idAdmin){
    ...
    @DeleteMapping("supprimer/{id}&{idAdmin}")
    String supprimer(@PathVariable Long id ,@PathVariable Long idAdmin){
        return promotionServiceImp.supprimerPromotion(id,idAdmin);
    }
}
