...
public class Promotion
{
    ...
    public Promotion(String nom, String annee, LocalDate dateDebut, LocalDate dateFin, int totalApprenants, int nombreFemmes, int nombreHommes, LocalTime horaireDebutJournee, LocalTime horaireFinJournee) {
        this.nom = nom;
        this.annee = annee;
