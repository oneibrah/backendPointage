...
public class AdministrateurServiceImpl implements AdministrateurService{
    ...
    public String supprimerAdmin(Long id, Long idSuperAdmin) {
        ...
        logServiceImp.addLogAdmin(superAdmin, "Suppression de l'Admin avec l'id: "+id+" par "+superAdmin.getPrenom()+" "+superAdmin.getNom());
        return "Vous avez supprimée l'admin dont id est : "+id;
    }
