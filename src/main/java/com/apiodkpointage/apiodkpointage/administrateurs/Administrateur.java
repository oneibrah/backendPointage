...
public class Administrateur
{
    ...
    public Administrateur(String nom, String prenom, String adresse, int telephone, String email, String login, String motDePass, LocalDate dateCreation, LocalDate dateModification, Etat etat) {
        this.nom = nom;
        this.prenom = prenom;
